...
| Organizer
| Creates and configures conferences (rooms, time slots). Assigns accepted sessions to the program. Triggers notifications to attendees about program changes.
...
node "Conference Management System\n(ASP.NET Core — Modular Monolith)" as sys {
  ...
  component "Session Module" as sess
