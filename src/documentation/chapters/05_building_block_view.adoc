...
| Conference
| Core
| Manages conferences, rooms, time slots, and the conference program. Owns the scheduling of sessions to slots. References sessions by ID only.

| Session
| Core
| Manages talks, speakers, abstracts, and tags. Sessions have their own lifecycle (submit → review → accept) independent of the conference program.
...
| Content
| Supporting
| Handles upload and distribution of presentation slides. Speakers upload slides linked to their sessions.
