...
public class SessionDependencyRules : ArchitectureTest
{
    ...
    private static TypesShouldConjunction CheckDependencies(System.Reflection.Assembly source, IEnumerable<System.Reflection.Assembly> target,
        params string[] allowedNamespaces)
    {
        ...
        allowedTypes = allowedNamespaces.Aggregate(allowedTypes, (current, allowedNamespace) => current.Or().ResideInNamespace($"{allowedNamespace}.*", true));
